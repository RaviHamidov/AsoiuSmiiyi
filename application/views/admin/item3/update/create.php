                ...
                <div class="p20">
                    ...
                    <input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash();?>" />
                        ...
                        <div id="aze" class="tab-content current">
                            ...
                            <input type="text" name="t_name" id="t_name" class="form-control" placeholder="Adı daxil edin" value="<?php echo $single_item->t_name ; ?>">
                            ...
                            <input type="text" name="t_surname" id="t_surname" class="form-control" placeholder="Soyadı daxil edin" value="<?php echo $single_item->t_surname ; ?>">
                            <!-- form validation start display show -->
                            <?php if(isset($form_error)){ ?>
                        ...
                        <label for="facebook">Facebook</label>
                            <input type="text" name="facebook" id="facebook" class="form-control" placeholder="Facebook ünvanını daxil edin" value="<?php echo $single_item->t_facebook; ?>">
                            <br>

                        <label for="linkedin">Linkedin</label>
                            <input type="text" name="linkedin" id="linkedin" class="form-control" placeholder="Linkedin ünvanını daxil edin" value="<?php echo $single_item->t_linkedin;?>">
                            <br>

                        <label for="twitter">Twitter</label>
                            <input type="text" name="twitter" id="twitter" class="form-control" placeholder="Twitter ünvanını daxil edin" value="<?php echo $single_item->t_twitter; ?>">
                            <br>
