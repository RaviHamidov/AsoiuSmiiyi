...
<div class="row">
    <div class="col-md-12">
        <div class="main-card mb-3 card">
            <div class="card-header"><?php echo "Fənn-Qrup əlaqəsi redaktə edin"; ?>
                    ...
                    <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2 noBlock">
                            ...
                            <select id="cate" class="form-control" name="category">
                                ...
                                <?php foreach ($get_all_item_category as $item){ ?>
                                    <option <?php if($single_item->re_group_no == $item->group_id){ echo "SELECTED"; } ?> value="<?php echo $item->group_id; ?>"><?php echo $item->group_no; ?></option>
                                <?php } ?>
                    ...
                    <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2 noBlock">
                            ...
                            <select id="cate" class="form-control" name="subject">
                                ...
                                <?php foreach ($get_all_item_subjects as $item){ ?>
                                    <option <?php if($single_item->re_subject_id == $item->ab_id){ echo "SELECTED"; } ?> value="<?php echo $item->ab_id; ?>"><?php echo $item->subject_name; ?></option>
                                <?php } ?>
