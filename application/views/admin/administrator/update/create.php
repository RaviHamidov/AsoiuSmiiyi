                ...
                <div class="p20">
                    ...
                    <input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash();?>" />
                        ...
                        <div id="aze" class="tab-content current">
                            ...
                            <input type="text" name="t_name" id="t_name" class="form-control" placeholder="Adı daxil edin" value="<?php echo $single_item->ad_name ; ?>">
                            ...
                            <input type="text" name="t_surname" id="t_surname" class="form-control" placeholder="Soyadı daxil edin" value="<?php echo $single_item->ad_surname ; ?>">
                            <!-- form validation start display show -->
                            <?php if(isset($form_error)){ ?>
                            ...
                            <input type="text" name="t_patronimic" id="t_patronimic" class="form-control" placeholder="Ata adını daxil edin" value="<?php echo $single_item->ad_patronimic ; ?>">
                            <br>
                            ...
                            <label for="description">Ətraflı</label>
