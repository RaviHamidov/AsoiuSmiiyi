            ...
            <div class="p20">
                ...
                <div id="aze" class="tab-content current">
                    <label for="sname">Ad</label>
                        <input type="text" name="s_name" id="s_name" class="form-control" placeholder="Adı daxil edin"  value="<?php echo $single_item->s_name ; ?>">
                        ...
                        <input type="text" name="s_surname" id="s_surname" class="form-control" placeholder="Soyadı daxil edin" value="<?php echo $single_item->s_surname ; ?>">
                        <!-- form validation start display show -->
                        <?php if(isset($form_error)){ ?>
                        ...
                        <input type="text" name="s_patronimic" id="s_patronimic" class="form-control" placeholder="Ata adını daxil edin" value="<?php echo $single_item->s_patronimic ; ?>">
                        <!-- form validation start display show -->
                        <?php if(isset($form_error)){ ?>
                        ...
                        <input type="text" name="s_phone" id="s_phone" class="form-control" placeholder="Telefon nömərsini daxil edin" value="<?php echo $single_item->s_phone; ?>">   
                        <br>
