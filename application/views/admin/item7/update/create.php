...
<div class="row">
    <div class="col-md-12">
        <div class="main-card mb-3 card">
            <div class="card-header"><?php echo "<b>".$single_item->tr_group_id."</b>"." - Training Edit"; ?>
                    ...
                    <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2 noBlock">
                        ...
                        <select id="cate" class="form-control" name="group">
                            ...
                            <?php foreach ($get_all_item_category as $item){ ?>
                                <option  <?php if($single_item->tr_group_id == $item->group_id){ echo "SELECTED"; } ?> value="<?php echo $item->group_id; ?>"><?php echo $item->group_no ; ?></option>
                            <?php } ?>
