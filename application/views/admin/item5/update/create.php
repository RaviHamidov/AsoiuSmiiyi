...
<div class="row">
    <div class="col-md-12">
        <div class="main-card mb-3 card">
            <div class="card-header"><?php echo "Redaktə"; ?>
            ...
            <div class="p20">
                ...
                <form action="<?php echo base_url('admin_updateItem_coAct/'.$single_item->co_id); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2 noBlock">
                        ...
                        <select id="cate" class="form-control" name="group">
                            <option value="">-Seçim edin-</option>

                            <?php foreach ($get_all_item_groups as $item){ ?>
                                <option <?php if($single_item->co_group_no == $item->group_id){ echo "SELECTED"; } ?>  value="<?php echo $item->group_id; ?>"><?php echo $item->group_no; ?></option>
                            <?php } ?>
                ...
                <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2 noBlock">
                        ...
                        <select id="cate" class="form-control" name="subject">
                            ...
                            <?php foreach ($get_all_item_subjects as $item){ ?>
                                <option <?php if($single_item->co_subject_id == $item->ab_id){ echo "SELECTED"; } ?>  value="<?php echo $item->ab_id; ?>"><?php echo $item->subject_name; ?></option>
                            <?php } ?>
