...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="main-card mb-3 card">
            <div class="card-header">Qrup-Fənn
                        ...
                        <tbody>
                            ...
                            <?php $itemCount = 1; $for_switch=0; foreach ($items as $item){ $for_switch++; ?>
                                <tr>
                                    ...
                                    <td>
                                    <?php foreach ($get_all_item_groups as $group){ ?>
                                        <?php if($group->group_id == $item->co_group_no) echo $group->group_no; ?></option>
                                <?php }  ?></td>
                                <td>
                                <?php foreach ($get_all_item_subjects as $subject){ ?>
                                        <?php if($subject->ab_id == $item->co_subject_id) echo $subject->subject_name; ?></option>
                                <?php }  ?></td>
