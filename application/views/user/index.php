        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-center justify-content-start"
                ...
                <div class="ftco-animate">
                    ...
                    <a href="<?php echo base_url('blog_single/') . $sl['id']; ?>"><button
                            class="btneal btn btn-primary px-4 py-3 mt-3">Elana get</button></a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-3 d-flex services align-self-stretch py-5 px-4 ftco-animate bg-darken">
                <div class="media block-6 d-block text-center">
                    ...
                    <div class="media-body p-2 mt-3">
                        ...
                        <p>Kariyeranızda böyük addım ataraq yeni ixtisasa yiyələnmək istəyirsinizsə, təkrar təhsil sizin
                            üçündür..</p>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row d-flex">
            <div class="col-md-5 order-md-last wrap-about wrap-about d-flex align-items-stretch">
                <div class="img"
                    style="background-image:url(<?php echo base_url('assets/user/'); ?>images/offer.jpeg); border">
                </div>
            </div>
                ...
                <div class="row mt-5">
                    <div class="col-lg-6">
                        <div class="services-2 d-flex">
                            ...
                            <div class="text pl-3">
                                <h3>15 ixtisas</h3>
                                <p>Arzuladığınız ixisası seçib bizə müraciət edə bilərsiniz. İnstitutumuzda 15 ixtisas
                                    üzrə tərdis aparılır.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="services-2 d-flex">
                            ...
                            <div class="text pl-3">
                                <h3>Faydalılıq</h3>
                                <p>Universitetimiz xalqımıza və bütün dünyaya fayda verəcək, inkişafı sürətləndirəcək
                                    araşdırma imkanı və təhsili təmin etməklə fəaliyyətini davam etdirir.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        <div class="services-2 d-flex">
                            ...
                            <div class="text pl-3">
                                <h3>Vacib dərslər</h3>
                                <p>Semestr ərzində sizə iş mühitində lazım olacaq biliklərə uyğun fənnlər üzrə təhsil
                                    alacaqsınız.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="services-2 d-flex">
                            ...
                            <div class="text pl-3">
                                <h3>Daha tez məzun olmaq imkani</h3>
                                <p>Növbəti semestrlərin dərslərini indidən götürüb daha sürətli şəkildə təhsilinizi
                                    tamamlaya bilərsiniz.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="services-2 d-flex">
                            ...
                            <div class="text pl-3">
                                ...
                                <p>Universitetimizin futbol, basketbol komandalarına qoşula və ya böyük kitabxanamızda
                                    araşdırmalar apara bilərsiniz.</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<section class="ftco-section ftco-counter img" id="section-counter"
    style="background-image:url(<?php echo base_url('assets/user/'); ?>images/bg_3.jpg);"
    ...
    <div class="container">
        <div class="row justify-content-center mb-5 pb-2 d-flex">
            ...
            <div class="col-md-6 heading-section heading-section-white ftco-animate pl-lg-5 pt-md-0 pt-5">
                ...
                <p>ADNSU-nun tərkibində fəaliyyət göstərən SMİİYİ tədris, təlim və tərbiyə hissəsinin sturuktur
                    bölməsidir. İnstitut 1996-cı il tarixdən indiyə kimi ADNSU-nun tərkibində qanunvericiliyin
                    tələblərinə uyğun, onun struktur bölməsi kimi fəaliyyət göstərir. Qanunvericiliyin dəyişməsi ilə
                    əlaqədar institutun fəaliyyətində ona uyğunlaşdırılır. İnstitutun əsasnaməsi yenidən işlənib
                    ADNSU-nın Elmi Şurasında qəbul edilərək universitetin Rektoru tərəfindən təsdiq edilmişdir. Əgər siz
                    də institutda təhsil almaq istəyirsinizsə, əlaqə bölməsinə keçərək məlumat əldə edə və ya aşağıdaki
                    formanı dolduraraq bir başa müraciət edə bilərsiniz
                <p><a style="background:#fd5f00;" href="<?php echo base_url('qeydiyyat') ?>"
                        class="btn btn-primary">Elektron Qeydiyyat</a></p>
                </p>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <a href="<?php echo base_url("team_single/") . $tech['ad_id'] ?>" title="">
                    <div class="staff hr-staff-effect">
                        <div class="img-wrap d-flex align-items-stretch">
                            <div class="img align-self-stretch"
                                style="background-image: url(<?php echo base_url('upload/administrator/' . $tech['ad_img']); ?>);">
                            </div>
                        </div>
                        <div class="text pt-3 text-center">
                            <h3><?php echo $tech['ad_name'] . " " . $tech['ad_surname']; ?></h3>
                            <a href="<?php echo base_url("team_single/") . $tech['ad_id'] ?>" title="">
                            </a>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3 ftco-animate">
                <div class="staff hr-staff-effect">
                    <div class="img-wrap d-flex align-items-stretch">
                        <div class="img align-self-stretch"
                            style="background-image: url(<?php echo base_url('upload/teachers/' . $tech['t_profile_photo']); ?>);">
                        </div>
                    </div>
                    <div class="text pt-3 text-center">
                        ...
                        <div class="faded">
                            <ul class="ftco-social text-center">
                                <li>
                                    <p style="text-shadow: 0 0 10px #000000;"><a style="color:white!important;"
                                            href="mailto:<?php echo $tech['t_e_mail']; ?>"><?php echo $tech['t_e_mail']; ?></a>
                                    </p>
                                </li>
                            </ul>
                        </div>
...
<section class="ftco-section container">
    <div class="container-fluid pb-4 ">
        ...
        <div class="row hr-Professions justify-space-between">
            <div class="hr-staff-effect col-lg-3 col-md-5 col-sm-12 course ftco-animate slider-height">
                <div class="img"
