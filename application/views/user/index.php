    ...
    <div class="container">
        <div class="row d-flex">
            <div class="col-md-5 order-md-last wrap-about wrap-about d-flex align-items-stretch">
                <div class="img"
                    style="background-image:url(<?php echo base_url('assets/user/');?>images/offer.jpeg); border"></div>
            </div>
    ...
    <div class="container">
        <div class="row justify-content-center mb-5 pb-2 d-flex">
            ...
            <div class="col-md-6 heading-section heading-section-white ftco-animate pl-lg-5 pt-md-0 pt-5">
                ...
                <p>
                    ADNSU-nun tərkibində fəaliyyət göstərən SMİİY intitutu tədris, təlim tərbiyə hissəsinin sturuktur
                    bölməsidir.
                    İnstitut 1996-cı il tarixdən hal-hazıra kimi ADNSU-nun tərkibində qanunvericiliyin tələblərinə
                    uyğun, onun sturuktur bölməsi kimi fəaliyyət göstərir.
                    Qanunvericiliyin dəyişməsi ilə əlaqədar institutun fəaliyyətində ona uyğunlaşdırlır.
                    İnstitutun əsasnaməsi yenidən işlənib ADNSU-nın elmi şurasında qəbul edilərək universitetin Rektoru
                    tərəfindən təsdiq edilmişdir.
                    Əgər siz də institutda təhsil almaq istəyirsinizsə, əlaqə bölməsinə keçərək məlumat əldə edə və ya
                    aşağıdaki formanı dolduraraq bir başa müraciət edə bilərsiniz
