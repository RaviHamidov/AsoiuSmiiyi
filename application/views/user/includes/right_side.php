          ...
          <div class="col-lg-4 sidebar my-sm-2">
            <div id="sd" class="">
              <h3>Ən son elanlar</h3>
               <?php foreach($event as $e){?>
                <div class="block-21 mb-4 d-flex">
                <a href="<?php echo base_url('blog_single/'.$e['id']); ?>">
                <img class="elan" src="<?php echo base_url('upload/events/'.$e['img']); ?>" />
               </a>
                   <div class="text">
                    <h3 class="heading ss"><a href="<?php echo base_url('blog_single/'.$e['id']); ?>"><?php echo $e['title'];?></a></h3>
                    <div class="meta">
                      <div><a href="#"><span class="icon-calendar"></span> <?php echo date('d-m-Y', strtotime($e['date']));?></a></div>
                    </div>
                  </div>
                </div>
               <?php }?>
