  ...
  <div class="container">
    <div class="row no-gutters slider-text align-items-center justify-content-center">
      <div class="col-md-9 ftco-animate text-center">
        <h1 class="mb-2 bread"><?php echo $x->title; ?></h1>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-8 ftco-animate">
        ...
        <div class="blogim">
          <img src="<?php echo base_url('upload/events/' . $x->img); ?>" onerror="this.onerror=null; this.src='<?php echo base_url('upload/teachers/') . 'alt.png'; ?>'" alt="image not found" class="img-fluid">
        </div>
        <p>
          <?php
          $ad_description = $x->description;

          $search = "<ul>";
          $replace = "<ul class = 'uls'>";

          $ad_description = str_replace($search, $replace, $ad_description);
          echo $ad_description ?></p>
      </div>
