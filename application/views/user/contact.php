...
<?php $this->load->view('user/includes/header');?>
    ...
    <section class="hero-wrap hero-wrap-2" style="background-image: url('<?php echo base_url('assets/user/');?>images/bg_127.jpg');">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Əlaqə</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Əsas səhifə <i class="ion-ios-arrow-forward"></i></a></span> <span>Əlaqə </span></p>
          </div>
        </div>
      </div>
    </section>
